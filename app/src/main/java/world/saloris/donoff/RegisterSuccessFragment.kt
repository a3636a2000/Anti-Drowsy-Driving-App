...
import world.saloris.donoff.databinding.FragmentRegisterSuccessBinding
...
class RegisterSuccessFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        /* Bottom Menu */
        val bottomMenu = requireActivity().findViewById<BottomNavigationView>(R.id.bottom_menu)
